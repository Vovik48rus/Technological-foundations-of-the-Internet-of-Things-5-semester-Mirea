...
CASE_NUMBER = 12
HOST = "192.168.2." + str(CASE_NUMBER) # IP чемодана
...
SUB_TOPICS = {
    ...
    '/devices/wb-ms_11/controls/Illuminance': 'light',
...
def on_message(client, userdata, msg):
    ...
    JSON_DICT['case'] = str(CASE_NUMBER)
    ...
    with open(f'data-{dt.day}-{dt.month}-{dt.year}-ver2.json', 'w') as file:
